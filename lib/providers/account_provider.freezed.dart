...
abstract class $AccountStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isLoading, bool isSaving, String? error, String? successMessage});
}
...
class _$AccountStateImpl implements _AccountState {
  ...
  @override
  String toString() {
    return 'AccountState(isLoading: $isLoading, isSaving: $isSaving, error: $error, successMessage: $successMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, isSaving, error, successMessage);
...
abstract class _AccountState implements AccountState {
  const factory _AccountState(
      ...
      final bool isSaving,
      final String? error,
      final String? successMessage}) = _$AccountStateImpl;
