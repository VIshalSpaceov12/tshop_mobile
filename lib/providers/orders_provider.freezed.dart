...
class _$OrdersStateImpl implements _OrdersState {
  ...
  @override
  String toString() {
    return 'OrdersState(orders: $orders, isLoading: $isLoading, isLoadingMore: $isLoadingMore, error: $error, currentPage: $currentPage, totalPages: $totalPages)';
  }
...
abstract class _OrdersState implements OrdersState {
  const factory _OrdersState(
      ...
      final String? error,
      final int currentPage,
      final int totalPages}) = _$OrdersStateImpl;
